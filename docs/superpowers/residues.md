...
| R139 | open | A same-file citation pointing DOWNWARD is falsified by the very edit correcting it — the `holon:05` fix wave's first attempt shifted its own cited line numbers before the reflow was made line-neutral; "measure before writing" does not guard this class |
