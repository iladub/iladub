...
| R174 | open | `test_stem_document_is_byte_identical_under_adoption` pins `0.9654553611484971` and the tree has read `0.9658886894075404` since `20cc5b8` ([[R154]]) — a READING change, not adoption; that commit re-baselined three OTHER pinned scores with written rulings and all three are non-corpus |
