...
| R151 | open | `holon:02 → holon:01` is still unauthored, and `R117` — the row that would have licensed it — is now closed. Split out so the strike stays honest; carries a falsifiable prediction the re-authoring must run first |
