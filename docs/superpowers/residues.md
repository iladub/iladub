...
| R161 | open | Loop Q's section repair never fires on apple p0/p2 — 8 of 11 escalations are `REGION_TILING_FAILED`, `DocumentReport.repaired_bands == ()` on both pages, cause unmeasured |
