...
| R61 | open | Emitter-typing is now an unenforced invariant — **0 instances measured 2026-08-18; the live ones are emitter/ontology disagreement, and the probe is renamed. NOT 14 any more: 32, measured 2026-09-08 — [[R179]]'s new shape flipped 18 nodes this row calls inert, and nothing noticed because nothing runs the probe. [[R182]] supplies the argument that settles the row's blocked modelling decision** |
