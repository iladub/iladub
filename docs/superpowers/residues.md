...
| R178 | open | who-wfa's `Year: Month` axis caption is ink the matrix reader carries into NO structure — now booked `escalated` so it is visible, but still unread **POPULATION MEASURED 2026-09-07**, only after [[R177]] was closed: **12 words in 2 documents**, not the 111 the blinded prober reported. Two shapes — the 3-word caption (who-wfa p0/p1/p2) and 9 uncarried header fragments + a date banner (graincorp-stem p0). The row's own "footnote / [[R166]] data-row" alternatives were instrument artefacts and are withdrawn |
