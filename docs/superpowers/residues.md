...
| R189 | open | The [[R187]] figure gate stops at tracked markdown — `src/iladub/etkl/compile.py:1288,1302` and `tests/etkl/test_datagrid.py:1085` state the superseded stem score `0.9654553611484971` as present fact, outside any gate. Do NOT inherit markdown's disposition: a `.py` file's decimals are mostly parameters |
